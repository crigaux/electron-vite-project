...
export function PropertySerializerReadFromJSON(json: any): PropertySerializerRead {
    return {
        ...
        'year_construction': !exists(json, 'year_construction') ? undefined : json['year_construction'],
        ...
        'agent_firstname': !exists(json, 'agent_firstname') ? undefined : json['agent_firstname'],
...
export function PropertySerializerReadToJSON(value?: PropertySerializerRead): any {
    ...
    return {
        ...
        'garden': value.garden,
        'draft': value.draft,
        'year_construction': value.year_construction,
