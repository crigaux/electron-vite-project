 ...
 */
function bookmarksGetBookmarkByUserIdRaw<T>(requestParameters: BookmarksGetBookmarkByUserIdRequest, requestConfig: runtime.TypedQueryConfig<T, Array<PropertySerializerRead>> = {}): QueryConfig<T> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
...
* Return all properties of a user by his id
*/
export function bookmarksGetBookmarkByUserId<T>(requestParameters: BookmarksGetBookmarkByUserIdRequest, requestConfig?: runtime.TypedQueryConfig<T, Array<PropertySerializerRead>>): QueryConfig<T> {
